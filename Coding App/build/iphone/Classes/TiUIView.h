...
/**
 Base class for all Hicks_Anthony_Coding_App views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Hicks_Anthony_Coding_App view hierarchy (such as wrapped iOS UIViews) was touched.
