...
/**
 The base class for all Hicks_Anthony_Coding_App modules
 */
...
/**
 Hicks_Anthony_Coding_App Platform calls this method on startup.
 */
-(void)startup;

/**
 Hicks_Anthony_Coding_App Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Hicks_Anthony_Coding_App Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Hicks_Anthony_Coding_App Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Hicks_Anthony_Coding_App Platform calls this method on resume.
 @param sender The sender of the event.
 */
