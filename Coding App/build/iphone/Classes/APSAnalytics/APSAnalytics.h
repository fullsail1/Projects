 ...
 * to send analytic data that can be viewed on the Hicks_Anthony_Coding_App Dashboard.
 *
 * For information on getting started with Hicks_Anthony_Coding_App Platform Services,
