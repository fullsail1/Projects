...
// in simulator we redefine to format for Hicks_Anthony_Coding_App Developer console
...
{\
	NSString * exceptionName = [@"org.hicks_anthony_coding_app." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hicks_anthony_coding_app";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHicks_Anthony_Coding_AppNativeItemNone = -1, 
	UIHicks_Anthony_Coding_AppNativeItemSpinner = -2,
	UIHicks_Anthony_Coding_AppNativeItemProgressBar = -3,
	
	UIHicks_Anthony_Coding_AppNativeItemSlider = -4,
	UIHicks_Anthony_Coding_AppNativeItemSwitch = -5,
	UIHicks_Anthony_Coding_AppNativeItemMultiButton = -6,
	UIHicks_Anthony_Coding_AppNativeItemSegmented = -7,
	
	UIHicks_Anthony_Coding_AppNativeItemTextView = -8,
	UIHicks_Anthony_Coding_AppNativeItemTextField = -9,
	UIHicks_Anthony_Coding_AppNativeItemSearchBar = -10,
	
	UIHicks_Anthony_Coding_AppNativeItemPicker = -11,
	UIHicks_Anthony_Coding_AppNativeItemDatePicker = -12,
	
	UIHicks_Anthony_Coding_AppNativeItemInfoLight = -13,
	UIHicks_Anthony_Coding_AppNativeItemInfoDark = -14,
	
	UIHicks_Anthony_Coding_AppNativeItemDisclosure = -15,
	
	UIHicks_Anthony_Coding_AppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hicks_Anthony_Coding_App instances of
