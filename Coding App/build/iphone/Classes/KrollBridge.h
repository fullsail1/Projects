...
@interface Hicks_Anthony_Coding_AppObject : KrollCoverageObject {
#else
@interface Hicks_Anthony_Coding_AppObject : KrollObject {
#endif
@private
...
extern NSString * Hicks_Anthony_Coding_App$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hicks_Anthony_Coding_AppObject *_hicks_anthony_coding_app;
    KrollObject* console;
	BOOL shutdown;
