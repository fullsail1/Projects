...
//@interface Hicks_Anthony_Coding_AppObject : NSObject
//@end

@interface Hicks_Anthony_Coding_AppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hicks_Anthony_Coding_AppObject class]])
		{
			for (NSString *key in [[(Hicks_Anthony_Coding_AppObject*)o modules] allKeys])
			{
