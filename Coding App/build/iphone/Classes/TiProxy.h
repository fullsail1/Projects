...
//Rare exceptions to indicate a bug in the _hicks_anthony_coding_app code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Hicks_Anthony_Coding_App proxies.
 */
