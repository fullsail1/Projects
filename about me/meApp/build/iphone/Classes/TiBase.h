...
// in simulator we redefine to format for meApp Developer console
...
{\
	NSString * exceptionName = [@"org.meapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.meapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImeAppNativeItemNone = -1, 
	UImeAppNativeItemSpinner = -2,
	UImeAppNativeItemProgressBar = -3,
	
	UImeAppNativeItemSlider = -4,
	UImeAppNativeItemSwitch = -5,
	UImeAppNativeItemMultiButton = -6,
	UImeAppNativeItemSegmented = -7,
	
	UImeAppNativeItemTextView = -8,
	UImeAppNativeItemTextField = -9,
	UImeAppNativeItemSearchBar = -10,
	
	UImeAppNativeItemPicker = -11,
	UImeAppNativeItemDatePicker = -12,
	
	UImeAppNativeItemInfoLight = -13,
	UImeAppNativeItemInfoDark = -14,
	
	UImeAppNativeItemDisclosure = -15,
	
	UImeAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all meApp instances of
