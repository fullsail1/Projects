...
/**
 The base class for all InfoApp_Project3 modules
 */
...
/**
 InfoApp_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 InfoApp_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 InfoApp_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 InfoApp_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 InfoApp_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
