...
//Rare exceptions to indicate a bug in the _infoapp_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for InfoApp_Project3 proxies.
 */
