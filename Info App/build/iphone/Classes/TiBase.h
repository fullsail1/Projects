...
// in simulator we redefine to format for InfoApp_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.infoapp_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.infoapp_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIInfoApp_Project3NativeItemNone = -1, 
	UIInfoApp_Project3NativeItemSpinner = -2,
	UIInfoApp_Project3NativeItemProgressBar = -3,
	
	UIInfoApp_Project3NativeItemSlider = -4,
	UIInfoApp_Project3NativeItemSwitch = -5,
	UIInfoApp_Project3NativeItemMultiButton = -6,
	UIInfoApp_Project3NativeItemSegmented = -7,
	
	UIInfoApp_Project3NativeItemTextView = -8,
	UIInfoApp_Project3NativeItemTextField = -9,
	UIInfoApp_Project3NativeItemSearchBar = -10,
	
	UIInfoApp_Project3NativeItemPicker = -11,
	UIInfoApp_Project3NativeItemDatePicker = -12,
	
	UIInfoApp_Project3NativeItemInfoLight = -13,
	UIInfoApp_Project3NativeItemInfoDark = -14,
	
	UIInfoApp_Project3NativeItemDisclosure = -15,
	
	UIInfoApp_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all InfoApp_Project3 instances of
