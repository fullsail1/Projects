...
@interface InfoApp_Project3Object : KrollCoverageObject {
#else
@interface InfoApp_Project3Object : KrollObject {
#endif
@private
...
extern NSString * InfoApp_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	InfoApp_Project3Object *_infoapp_project3;
    KrollObject* console;
	BOOL shutdown;
