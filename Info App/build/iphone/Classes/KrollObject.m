...
//@interface InfoApp_Project3Object : NSObject
//@end

@interface InfoApp_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[InfoApp_Project3Object class]])
		{
			for (NSString *key in [[(InfoApp_Project3Object*)o modules] allKeys])
			{
